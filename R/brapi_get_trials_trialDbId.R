...
#'
#' @details Get trial by id.
#'
#' @return data.frame
#'
#' @author brapir generator package
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Trials/get_trials__trialDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
#' @family Trials
#'
...
brapi_get_trials_trialDbId <- function(con = NULL, trialDbId = '') {
  ...
  brapi_checkArgs(usedArgs, reqArgs = "trialDbId")
  ## Obtain the call url
