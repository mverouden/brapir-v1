...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Germplasm/get_search_germplasm__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
#' @family Germplasm
...
#'
#' @export
brapi_get_search_germplasm_searchResultsDbId <- function(con = NULL, searchResultsDbId = '', page = 0, pageSize = 1000) {
