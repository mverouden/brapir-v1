...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Images/get_search_images__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
#' @family Images
...
#'
#' @export
brapi_get_search_images_searchResultsDbId <- function(con = NULL, searchResultsDbId = '', page = 0, pageSize = 1000) {
