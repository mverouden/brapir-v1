...
#'
#' @details Returns a list of observationUnit with the observed Phenotypes. observationTimeStamp needs to be specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) formatting.
#'
#' @return data.frame
#'
