...
#'
#' @details Call to retrieve a list of observation variable ontologies available in the system.
#'
#' @return data.frame
#'
#' @author brapir generator package
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Observation%20Variables/get_ontologies }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
#' @family Observation Variables
#'
#' @export
brapi_get_ontologies <- function(con = NULL, page = 0, pageSize = 1000) {
