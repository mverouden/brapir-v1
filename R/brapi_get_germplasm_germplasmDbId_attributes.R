...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Germplasm%20Attributes/get_germplasm__germplasmDbId__attributes }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
