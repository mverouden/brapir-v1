...
#' @param scaleDbId character; required: TRUE; internal database identifier of the scale to update details of; default: &quot;&quot;.
...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Observation%20Variables/put_scales__scaleDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
...
#'
#' @export
brapi_put_scales_scaleDbId <- function(con = NULL, scaleDbId = '', dataType = '', decimalPlaces = 0, ontologyReference = list(), scaleName = '', validValues = list(), xref = '') {
