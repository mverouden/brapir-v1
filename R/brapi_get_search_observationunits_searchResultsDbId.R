...
#'
#' @references \href{https://app.swaggerhub.com/apis/PlantBreedingAPI/BrAPI/1.3#/Observations/get_search_observationunits__searchResultsDbId_ }{BrAPI SwaggerHub}
#'
#' @family brapi_1.3
#' @family Observations
